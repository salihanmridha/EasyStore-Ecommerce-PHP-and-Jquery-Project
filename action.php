...
if(isset($_POST["category"])){
	...
	if(isset($_SESSION["uid"]) and ($_SESSION["role"] == 1)){
		echo "
			<div class='nav nav-pills nav-stacked'>
				<li class='active'><a href='admin/addcategory.php'><h4>Add Categories</h4></a></li>
			";
		...
		if(mysqli_num_rows($run_query) > 0){
			while($row = mysqli_fetch_array($run_query)){
				...
				<li class='clearfix'>
					<a href='#' style='display:inline-block' class='category' cid='$cid'>$cat_name</a>
					<a href='admin/editCat.php?id=$cid' style='display:inline-block; float:right; width:52px' class='btn-sm btn-primary' cid='$cid'>Edit</a>
				</li>
...
if(isset($_POST["brand"])){
	...
	if(isset($_SESSION["uid"]) and ($_SESSION["role"] == 1)){
		echo "
			<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='admin/addbrand.php'><h4>Add Brands</h4></a></li>
		";
		...
		if(mysqli_num_rows($run_query) > 0){
			while($row = mysqli_fetch_array($run_query)){
				...
				echo "
						<li class='clearfix'>
						<a href='#' class='selectBrand' style='display:inline-block' bid='$bid'>$brand_name</a>
						<a href='admin/editBrand.php?id=$bid' style='display:inline-block; float:right; width:52px' class='btn-sm btn-primary' bid='$bid'>Edit</a>
						</li>
				";
			}
			echo "</div>";
					...
					<div class='col-md-4'>
								<div class='panel panel-info'>
									...
									<div class='panel-heading'>$.$pro_price.00
										<a style='display:inline-block; float:right; margin-left:2px' href='admin/editproduct.php?id=$pro_id' class='btn btn-danger btn-xs'>Edit Product</a>
										
										<a style='display:inline-block; float:right'  href='admin/deleteProduct.php?id=$pro_id' class='btn btn-danger btn-xs'>Delete</a>
									</div>
